...
class ActorReview:
    ...
    def __init__(self, actor: Actor, review_text: str, rating: int, user):
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        return other.actor == self.__actor and other.review_text == self.__review_text and other.rating == self.__rating and other.timestamp == self.__timestamp

    def __repr__(self):
        return f'<Review of movie {self.__actor}, rating = {self.__rating}, timestamp = {self.__timestamp}>'


class DirectorReview:

    def __init__(self, director: Director, review_text: str, rating: int, user):
        if isinstance(director, Director):
            self.__director = director
        else:
            self.__director = None
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        return other.director == self.__director and other.review_text == self.__review_text and other.rating == self.__rating and other.timestamp == self.__timestamp

    def __repr__(self):
        return f'<Review of movie {self.__director}, rating = {self.__rating}, timestamp = {self.__timestamp}>'
